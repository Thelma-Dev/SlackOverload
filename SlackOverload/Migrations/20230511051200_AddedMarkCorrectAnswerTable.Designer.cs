...
namespace SlackOverload.Migrations
{
    ...
    [Migration("20230511051200_AddedMarkCorrectAnswerTable")]
    partial class AddedMarkCorrectAnswerTable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SlackOverload.Models.MarkedAnswers", b =>
                {
                    b.Property<int>("id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SlackOverload.Models.QuestionTag", b =>
                {
                    ...
                    b.HasOne("SlackOverload.Models.Tags", "Tag")
                        .WithMany("QuestionTags")
                        .HasForeignKey("TagId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
